   ...
   <section>
     <form method="POST" action="resumen.php">
       <table border="1" width="700" cellspacing="10" cellpadding="0">
          ...
          <tr>
            <td>¿Cómo se siente a nivel de seguridad en la ciudad de Saltadilla?
            </td>
            <td><?php echo $pregunta1; ?></td>
          </tr>
          <tr>
            <td>¿Qué tipo de delito cree usted que es el más
                común en la ciudad?</td>
          ...
          <tr>
            <td>¿Usted conoce las medidas de seguridad que tiene actualmente Saltadilla?</td>
